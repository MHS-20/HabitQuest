...
import habitquest.notification.application.NotificationLogger;
...
@Adapter
@Component
public class NotificationJsonLogger implements NotificationLogger {

  private final Logger log = LoggerFactory.getLogger(NotificationJsonLogger.class);
  private final ObjectMapper objectMapper;

  public NotificationJsonLogger(ObjectMapper objectMapper) {
