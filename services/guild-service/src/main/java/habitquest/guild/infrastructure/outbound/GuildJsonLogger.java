...
@Adapter
@Component
public class GuildJsonLogger implements GuildLogger {

  private final Logger log = LoggerFactory.getLogger(GuildJsonLogger.class);
  private final ObjectMapper objectMapper;

  public GuildJsonLogger(ObjectMapper objectMapper) {
