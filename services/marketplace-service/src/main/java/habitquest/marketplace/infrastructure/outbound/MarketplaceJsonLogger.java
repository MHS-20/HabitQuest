...
@Adapter
@Component
public class MarketplaceJsonLogger implements MarketplaceLogger {

  private final Logger log = LoggerFactory.getLogger(MarketplaceJsonLogger.class);
  private final ObjectMapper objectMapper;

  public MarketplaceJsonLogger(ObjectMapper objectMapper) {
