package habitquest.edge.infrastructure.outbound;
...
@Adapter
@Component
public class EdgeJsonLogger implements EdgeLogger {

  private final Logger log = LoggerFactory.getLogger(EdgeJsonLogger.class);
  private final ObjectMapper objectMapper;

  public EdgeJsonLogger(ObjectMapper objectMapper) {
