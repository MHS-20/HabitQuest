...
@Adapter
@Component
public class QuestJsonLogger implements QuestLogger {

  private final Logger log = LoggerFactory.getLogger(QuestJsonLogger.class);
  private final ObjectMapper objectMapper;

  public QuestJsonLogger(ObjectMapper objectMapper) {
