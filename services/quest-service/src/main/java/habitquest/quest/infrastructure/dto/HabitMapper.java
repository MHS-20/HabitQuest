...
public class HabitMapper {
  ...
  public static Habit toDomain(String habitId, QuestController.AddHabitRequest request) {
    return new Habit(
        new Id<>(habitId),
        request.title(),
        request.description(),
  ...
  private static Recurrence toRecurrence(QuestController.RecurrenceRequest request) {
    if (request == null) {
      return null;
    }
