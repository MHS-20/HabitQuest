...
fun CreateGuildDialog(
    ...
    AlertDialog(
        ...
        confirmButton = {
            TextButton(onClick = onCreate, enabled = !loading) {
                Text("Create")
            }
        },
        dismissButton = {
                                ...
                                Card(
                                    ...
                                    Column(
                                        ...
                                        Button(
                                            ...
                                            Text(if (acceptingInviteId == invite.inviteId) "Accepting..." else "Accept invite")
                                        }
                                    }
                                }
                            }
...
fun BattleSelectionDialog(
    ...
    AlertDialog(
        ...
        dismissButton = {
            TextButton(onClick = onDismiss, enabled = !battleStarting) {
                Text("Cancel")
            }
        }
    )
