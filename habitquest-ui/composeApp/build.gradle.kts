...
android {
  ...
  compileSdk = uiLibs.versions.android.compileSdk.get().toInt()

  defaultConfig {
    applicationId = "habitquest.ui"
    minSdk = uiLibs.versions.android.minSdk.get().toInt()
    targetSdk = uiLibs.versions.android.targetSdk.get().toInt()
    versionCode = 1
