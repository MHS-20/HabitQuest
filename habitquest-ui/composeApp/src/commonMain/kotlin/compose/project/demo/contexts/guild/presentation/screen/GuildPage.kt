...
import compose.project.demo.contexts.guild.infrastructure.repository.AcceptInviteResult
import compose.project.demo.contexts.guild.infrastructure.repository.BattleAttackResult
import compose.project.demo.contexts.guild.infrastructure.repository.BattleStartResult
import compose.project.demo.contexts.guild.infrastructure.repository.BattleStatsData
import compose.project.demo.contexts.guild.infrastructure.repository.BattleStatsResult
import compose.project.demo.contexts.guild.infrastructure.repository.BossData
import compose.project.demo.contexts.guild.infrastructure.repository.BossesResult
import compose.project.demo.contexts.guild.infrastructure.repository.GuildCreateResult
import compose.project.demo.contexts.guild.infrastructure.repository.GuildData
import compose.project.demo.contexts.guild.infrastructure.repository.GuildLeaderboardResult
import compose.project.demo.contexts.guild.infrastructure.repository.GuildRepository
import compose.project.demo.contexts.guild.infrastructure.repository.InviteAvatarResult
import compose.project.demo.contexts.guild.infrastructure.repository.PendingInviteData
import compose.project.demo.contexts.guild.infrastructure.repository.PendingInvitesResult
import compose.project.demo.contexts.guild.infrastructure.repository.SearchAvatarData
import compose.project.demo.contexts.guild.infrastructure.repository.SearchAvatarResult
            ...
            onClick = {
                ...
                scope.launch {
                    ...
                    when (val result = repository.fetchPendingInvites(token, currentAvatar.id)) {
                        is PendingInvitesResult.Success -> {
                                ...
                                is BattleStatsResult.Error -> {
                                    if (isLeader) {
                                        ...
                                        when (val bossesResult = repository.fetchBosses(token)) {
                                            is BossesResult.Success -> {
                                                bosses = bossesResult.bosses
                                            }
