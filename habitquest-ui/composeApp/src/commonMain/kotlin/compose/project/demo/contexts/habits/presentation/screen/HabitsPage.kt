package compose.project.demo.contexts.habits.presentation.screen
...
import compose.project.demo.contexts.habits.infrastructure.calendar.HabitCalendarLaunchResult
...
fun HabitsScreen(
    ...
    suspend fun loadHabits(showLoading: Boolean) {
        ...
        uiState =
            when {
                token.isBlank() -> {
                    HabitsUiState.Error("Invalid session")
                }

                avatar == null -> {
                    HabitsUiState.Error("Avatar not available")
                }
            ...
            Text(
                ...
                color =
                    if (
                        ...
                        message.startsWith("Calendar event added")
                    ) {
