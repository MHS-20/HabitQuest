...
interface AvatarGateway {
  ...
  suspend fun increaseStrength(token: String, avatarId: String): AvatarStatIncrementResult

  suspend fun increaseDefense(token: String, avatarId: String): AvatarStatIncrementResult

  suspend fun increaseIntelligence(token: String, avatarId: String): AvatarStatIncrementResult
}
