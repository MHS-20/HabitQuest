package compose.project.demo.contexts.avatar.presentation.screen
...
fun CharacterScreen(
    ...
    val buyEquipItemUseCase =
        remember {
            BuyEquipItemUseCase(marketplaceRepository, avatarRepository)
        }
    ...
    suspend fun loadEquippedItems(avatarId: String) {
        when (val result = avatarRepository.fetchEquippedItems(avatarId = avatarId, token = token)) {
            ...
            is AvatarEquippedItemsResult.Error -> {
                                            ...
                                            Button(
                                                onClick = {
                                                    scope.launch {
                                                        ...
                                                        val result =
                                                            buyEquipItemUseCase.toggleEquip(
                                                                token = token,
