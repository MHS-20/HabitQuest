...
argocd app create tracking-service \
 --repo \
 https://github.com/MHS-20/habitquest.git \
 --path deployment/kubernetes/applications/tracking-service/ \
...
argocd app create marketplace-service \
 --repo \
 https://github.com/MHS-20/habitquest.git \
 --path deployment/kubernetes/applications/marketplace-service/ \
  --dest-server https://kubernetes.default.svc \
 --dest-namespace default \
 --sync-policy auto \
 --auto-prune
...
argocd app create guild-service \
 --repo \
 https://github.com/MHS-20/habitquest.git \
 --path deployment/kubernetes/applications/guild-service/ \
  --dest-server https://kubernetes.default.svc \
 --dest-namespace default \
 --sync-policy auto \
 --auto-prune
...
argocd app create notification-service \
 --repo \
 https://github.com/MHS-20/habitquest.git \
 --path deployment/kubernetes/applications/notification-service/ \
  --dest-server https://kubernetes.default.svc \
 --dest-namespace default \
 --sync-policy auto \
 --auto-prune
...
argocd app create edge-service \
 --repo \
 https://github.com/MHS-20/habitquest.git \
 --path deployment/kubernetes/applications/edge-service/ \
  --dest-server https://kubernetes.default.svc \
 --dest-namespace default \
 --sync-policy auto \
 --auto-prune
...
argocd app create quest-service \
 --repo \
 https://github.com/MHS-20/habitquest.git \
 --path deployment/kubernetes/applications/quest-service/ \
  --dest-server https://kubernetes.default.svc \
 --dest-namespace default \
 --sync-policy auto \
 --auto-prune